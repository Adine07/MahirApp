...
<div class="card-box mb-30">
	...
	@endif
	<div class="pd-20">
		<form id="locations" action="{{ route('category.update', $category->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
			<div class="form-group row">
				<label class="col-12 col-form-label">Category Name</label>
				<div class="col-12">
					<input class="form-control" type="text" name="name" value="{{ old('name', $category->name) }}"  placeholder="Pembayaran">
				</div>
			</div>
			<div class="row">
				<div class="col-sm-12">
